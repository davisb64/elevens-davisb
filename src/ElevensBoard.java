...
public class ElevensBoard extends Board{
	...
	public boolean anotherPlayIsPossible() {
		/* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
                ...
                return this.containsPairSum11(cardsLeft) || this.containsJQK(cardsLeft);
	}
		...
		/* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
                for(Integer i : selectedCards){
                    for(Integer j : selectedCards){
                        if(cardAt(i).pointValue() + cardAt(j).pointValue() == 11 && i != j){ return true;
                        }
                    }
                }
                return false;
	...
	private boolean containsJQK(List<Integer> selectedCards) {
		/* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
                ...
                for(int i : selectedCards){
                    ...
                    if(cardAt(i).rank().equals("king")) foundKing = true;
                    if(cardAt(i).rank().equals("queen")) foundQueen = true;
                }
